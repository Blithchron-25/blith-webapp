...
const Rewards =  () => {
  ...
  return (
    ...
    <div className="w-screen h-screen flex flex-col ml-0 items-center" style={{backgroundImage: `url(${bg})`}}>
        ...
        <h1 className="text-3xl font-bold drop-shadow-lg mt-[10px] text-white" style={{ textShadow: "5px 0px 10px rgb(156, 10, 119)"}}>BLITHCOIN</h1>
        <h3 className="text-2xl mt-[10px] mb-[40px] font-bold drop-shadow-lg text-white" style={{ textShadow: "5px 0px 10px rgb(156, 10, 119)"}}>{blithCredits}</h3>
        {userUid && <QrCard value={userUid} /> }{/* change this value to the user's unique uid */}
    </div>
  );
};
